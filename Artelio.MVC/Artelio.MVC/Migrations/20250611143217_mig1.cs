        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentAction = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContentController = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AbilityName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSocialMedias_SocialMediaLinks_SocialMediaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkExperiences_Works_WorkId",
                        column: x => x.WorkId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_viewerProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_viewerProjects_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_viewerProjects_UserProjects_ProjectId",
                        column: x => x.ProjectId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_viewerProjects_ProjectId",
                table: "viewerProjects",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_viewerProjects_UserId",
                table: "viewerProjects",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_WorkId",
                table: "WorkExperiences",
                column: "WorkId");
        }
